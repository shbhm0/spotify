...
import Playlist2 from '../screen/searchPlaylist'
...
Home1(){
    return(
      <Stack1.Navigator headerMode={'none'} initialRouteName="Home">
        ...
        <Stack1.Screen name="Player" component={Player} />
      </Stack1.Navigator>
...
search(){
      return(
        <Stack2.Navigator headerMode={'none'} initialRouteName="Search">
          ...
          <Stack2.Screen name="Playlist2" component={Playlist2}/>
          <Stack1.Screen name="Player" component={Player}/>
        </Stack2.Navigator>
  ...
  render() {
    return (
        <Tab.Navigator tabBarOptions={{showLabel:true,activeTintColor:'white',inactiveTintColor:'#d9d9d9',style:{
         ...
         <Tab.Screen name="Search" component={this.search}
           ...
           <Tab.Screen name="Premium" component={Premium}
            options={{
              tabBarIcon:({focused})=>focused ? (
                <Image style={styles.tabIcon} source={require('../assets/spotify_active.png')}/>):
                (<Image style={styles.tabIcon} source={require('../assets/spotify_inactive.png')}/>)
